...
public class POSTCommentsTest extends ApiBaseClass {
    ...
    public void createComment() {
        ...
        Comment response = restWrapper.usingComments().createComment(body);
    ...
    public void createCommentWithInvalidOwnerId() {
        ...
        ErrorModel response = restWrapper.usingComments().createCommentWithFailure(body);
    ...
    public void createCommentWithoutAuthorization() {
        ...
        ErrorModel response = restWrapperWithoutAuth.usingComments().createCommentWithFailure(body);
